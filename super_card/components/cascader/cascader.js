...
exports.default = Component({
  ...
  methods: {
    ...
    nextStep: function nextStep(e, tbmode) {
      ...
      this.data.step++;
      this.data.newArray.push([]);
      if (!this.data.newArray[this.data.step - 1][selectIndex].sub) {
        // 点击最后的一项
      ...
      this.data.newArray[this.data.step - 1][selectIndex].sub.forEach(function (element) {
    ...
    itemTapHandler: function itemTapHandler(e) {
      console.log(e.currentTarget.dataset.item[this.data.nameKey]);

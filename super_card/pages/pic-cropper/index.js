...
Page({
  ...
  onLoad: function (options) {
    ...
    if(!options.pic_id)
      that.setData({ imageSrc: options.path, pic_index: options.pindex })
    else
      that.setData({ pic_id: options.pic_id, imageSrc: options.path })
    ...
    ctx.draw(true, () => {
      ...
      wx.canvasToTempFilePath({
        ...
        success: function (res) {
          ...
          _this.updateCardPic(res.tempFilePath)
          /*wx.previewImage({

...
Page({
  ...
  onLoad: function (options) {
    ...
    if(typeof options.umoney == 'undefined' || typeof options.sid == 'undefined'){
    ...
    this.setData({ sid: options.sid , uMoney: uMoney, account_intro: app.config.getConf('account_intro') })
  ...
  showMoneyPay: function (isCheck){
    ...
    var fee = Math.round(app.config.getConf('square_top_fee') * 100) / 100
